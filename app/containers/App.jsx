...
import { fetchList, isAppending, fetchArticle, canInput, closeInput, postArticle} from '../actions/article';
...
const App = React.createClass({
	...
	componentDidUpdate(prevProps) {
		...
		const oldId = prevProps.params.type;
		const newId = this.props.params.type;
		if (newId !== oldId) {
	...
	render() {
		const append = (<div className="tail"><div className="appending">
